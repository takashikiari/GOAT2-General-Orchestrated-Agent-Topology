...
def _load_snapshot_entries(benchmark_path: str, collection_name: str) -> list[dict]:
    ...
    client = chromadb.PersistentClient(
        path=benchmark_path, settings=Settings(anonymized_telemetry=False),
    )
...
async def main() -> int:
    ...
    ap.add_argument("--benchmark-path", default="chroma_data_benchmark",
                     help="benchmark ChromaDB path (default: chroma_data_benchmark)")
    ...
    registry = ServiceRegistry(episodic_storage_path=args.benchmark_path)
