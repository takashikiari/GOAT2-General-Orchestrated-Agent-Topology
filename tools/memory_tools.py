...
MEMORY_SEARCH = ToolDefinition(
    ...
    parameters={"type": "object", "required": ["query"], "properties": {
        ...
        "tier": {"type": "string", "enum": list(_ANY_TIERS), "description": "Tier to search (default: 'any').", "default": "any"},
    }},
...
MEMORY_GET = ToolDefinition(
    name="memory_get",
    description="Retrieve a memory entry by exact key. Use tier='any' to probe all layers.",
    parameters={"type": "object", "required": ["key"], "properties": {
        "key":  {"type": "string", "description": "Exact memory key."},
        "tier": {"type": "string", "enum": list(_ANY_TIERS), "description": "Tier to probe (default: 'any' = all).", "default": "any"},
    }},
...
MEMORY_STORE = ToolDefinition(
    name="memory_store",
    description="Store a key-value pair in a memory tier (default: working/Redis).",
    parameters={"type": "object", "required": ["key", "value"], "properties": {
        "key":   {"type": "string", "description": "Memory key."},
        "value": {"type": "string", "description": "Content to store."},
        "tier":  {"type": "string", "enum": list(_TIERS), "description": "Target tier (default: 'working').", "default": "working"},
    }},
